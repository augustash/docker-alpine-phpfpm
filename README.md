...
- `4.0.0`, `latest` [(Dockerfile)](https://github.com/augustash/docker-alpine-phpfpm/blob/4.0.0/Dockerfile)
- `3.0.1` [(Dockerfile)](https://github.com/augustash/docker-alpine-phpfpm/blob/3.0.1/Dockerfile)
- `3.0.0` [(Dockerfile)](https://github.com/augustash/docker-alpine-phpfpm/blob/3.0.0/Dockerfile)
